...
class ChatbotUsecase:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            f"- SEMPRE escreva o número de WhatsApp em negrito (entre **), exemplo: **{settings.BUSINESS_PHONE}**\n"
            f"- Para pedidos online, sugira o iFood: {settings.BUSINESS_IFOOD_LINK}\n"
            f"- Para receitas, indique: {settings.BUSINESS_RECIPES_URL}\n"
            f"- Para receitas, se o cliente quiser saber como é feito os produtos busque informações no: {settings.BUSINESS_RECIPES_URL}"
            ...
            f"- Você vai ressaltar que os preços que estão no site é somente pra retirada na loja. E que pro ifood consultar os valores dentro da plataforma."
        )
