export const adminProdutosStyles = {
  ...
  // Filtro
  filterWrapper: "flex items-center gap-3",
  ...
  tdImg: "px-4 py-3",
  img: "w-12 h-12 object-cover rounded-lg",
  ...
  modal: "bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto",
  modalHeader: "flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white",
  ...
  modalFooter: "px-6 py-4 border-t border-gray-200 flex justify-end gap-3 sticky bottom-0 bg-white",
  ...
  textarea: "w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 transition resize-none",
